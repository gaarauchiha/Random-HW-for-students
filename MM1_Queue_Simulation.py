...
class Simulator: 
    ...
    def gen_service_time(self):                               
        return np.random.uniform(2.5, 5.8)
    ...
    def report_generation(self):
        ...
        print("Average number of customers in queue: ", self.weighted_queue_length / self.clock)
        print("Maximum number of customers in queue is: ", self.max_queue_length)
